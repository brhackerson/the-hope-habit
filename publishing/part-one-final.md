...
*By Brian Hackerson*
*Working draft — combined June 9, 2026*

# Chapter 1: I Called It Hope. I Was Just Waiting.

*Third Draft — May 24, 2026*
...
- The central thesis: hope is not a feeling, it is a practice
- The lie: hope as passive waiting
- The inner critic: defined and illustrated
- Imposter syndrome: defined and distinguished from the inner critic
- Snyder's Hope Theory: agency and pathways (cite: Snyder 2002, endnote 1)
- Hope vs. optimism distinction
- Hope vs. grit distinction (cite: Duckworth, Grit, endnote 2)
- Manson's counterintuitive framing (cite: Manson, Everything Is F*cked, 2019, endnote 3)
- The "win" language resolution: Warnock Easter 2026 framing (endnote 4)
- Dr. Michael Gervais: optimism can be trained (endnote 5)
- Brian's father: eternal optimist who paid with his health
- Brian's mother: star word on Epiphany Sunday, January 6, 2026
- Debby: Brian's wife, introduced briefly
- The inner critic's favorite line: "You can't... fill in the blank"
- The February 2025 doctor's visit as the inflection point
- The reader bridge: your journey, your voices, your practice
**References forward:**
- Agency and pathways explored more deeply in Chapter 2
- The inner critic gets full treatment in Chapter 5
- The keyword introduced in Chapter 4
- The doctor's visit and rock bottom explored more in Chapter 2
- The neuroscience of hope in Chapter 3
**References back:**
- None (this is Chapter 1)
**Key quotes to protect:**
- "You can't... fill in the blank" (inner critic)
- "What would it look like if I could figure this out?" (the opening question)
- "Hope is available in abundant supply" (closing)
- "The tomb does not get the last word" (Warnock)
- "Optimism says things will be okay. Hope shows you what to do next."
- "You can do hard things when the why is important enough."

# Chapter 2: Hope Looks Different From Here

*Eighth Draft — May 25, 2026*
...
***Chapter Notes***
**Introduced in this chapter:**
- The February 2025 doctor's visit: finger on screen, A1C defined, lab results, phone call to Debby
- The drive home: I-90, winter sun, intermittent fasting podcast, the decision
- The first morning: quiet satisfaction, one sprint
- Scrum defined: sprints, inspect and adapt, Dr. Jeff Sutherland, 3M, Scrum Inc.
- Agile Best Self mindset introduced (grounding sentence confirmed: "a mindset developed to apply agile principles to personal growth and self-care")
- Agency and pathways defined more fully
- InBody scan defined
- Creatine monohydrate defined with research citation
- Receipt defined with three concrete examples
- Why Power (Colla et al. 2022)
- Anchor/keyword: origin story via Sinek, Gervais, North Star Workshop
- Michaele Gardner introduced as co-creator of Agile Best Self
- We Power (Colla et al. 2022): Kaylee/Dr. Lee creatine story
- Pink's autonomy, mastery, purpose
- The infinite game (Sinek)
- The Hope Cycle named: build, receive, recognize, release
- Father portrait: second phone calls, memory care, 2022, the fear
- Dr. Gupta's lifestyle statistic referenced
- May 2025 Dr. Lee visit: first receipt of real momentum
- "When nothing happens, nothing happens" (source unknown, attributed to former boss)
**References back to:**
- Chapter 1: agency and pathways; inner critic; February visit
- Chapter 1: "What would it look like if I could figure this out?"
**References forward:**
- Chapter 3: neuroscience of hope; Dr. Gupta
- Chapter 4: the anchor/keyword introduced fully
- Chapter 5: inner critic full treatment
**Key quotes:**
- "Motivation is a passenger, not a driver."
- "Persistence without flexibility isn't hope. It's stubbornness wearing hope's clothes."
- "The wall isn't always a dead end. Sometimes it's a redirect sign."
- "It's data. Not a judgment. Not a verdict on your character or your capacity."
- "When nothing happens, nothing happens."
- "The hope you were waiting for was never going to arrive on its own. Waiting doesn't work. The practice does. Stay with it long enough and it starts to compound."

# Chapter 3: The 90 Percent

*Third Draft — May 27, 2026*
...
***Chapter Notes***
**Introduced in this chapter:**
- The 90 percent: Gupta's research — 90% lifestyle-related, 10% genetic
- BDNF: brain-derived neurotrophic factor — Ratey's "miracle-gro for the brain"
- Sleep as the brain's maintenance window
- Sleep apnea and CPAP: defined and receipt
- Circadian rhythm: illustrated through father's decline
- HRV (heart rate variability): defined on first use
- Whoop sensor: sleep and recovery tracking tool
- The couch scenario: inner critic dressed as consideration
- The 1 pm caffeine cutoff: Whoop-driven experiment
- Nutrition mindfulness: "what sounds good?" vs. "what makes me feel good?"
- Daily structure: fasted training, food window, timing
- The inner circle breakfast: sustainability built in
- Supplement goal: lean muscle mass after 50
- Post-workout drink: timing and delivery
- The 2006 conversation: stewardship promised, honor not burden
- The October 2025 hospital room: steadiness as receipt
- Connection for protection: Gupta Chapter 8
- The treadmill milestone: behavioral receipt
- The procrastination lift: cognitive receipt
**References back to:**
- Chapter 1: the father; inner critic
- Chapter 2: drive home; first morning; creatine; Dr. Lee; Kaylee; receipt; We Power; infinite game fear
**References forward:**
- Chapter 4: the anchor/keyword
- Chapter 5: inner critic full treatment
**Key quotes to protect:**
- "Always, always, always felt better when I leave the gym."
- "The gym doesn't just build the body. It resets the mind before the day has a chance to set the terms."
- "What sounds good? became what makes me feel good?"
- "The hope practice doesn't just build hope. It builds the brain that sustains hope when everything else is trying to drain it."
- "Ask yourself one question before the next morning begins: what does my system need today to give it the best shot?"

# Chapter 4: The Foundation You're Already Standing On

*Second Draft — June 2026*
...
***Chapter Notes***
**Introduced in this chapter:**
- The five Scrum values: commitment, focus, openness, respect, courage — as personal operating system
- Dr. Jeff Sutherland: scientist, receipts, infinite game model
- The June 2017 decision: Corporate Research Systems Lab transformation
- Father's 1985 letter: Items 7 and 8 = ABS Principles 7 and 8, written 40 years early (age at time of letter flagged — see Working Notes)
- Agile Best Self: mindset for continuous personal growth (not a framework)
- Naming history: originally Agile Self-Care; renamed Agile Best Self — Michaele's oxygen-mask analogy
- ABS timeline: met Michaele at the 2018 Global Scrum Gathering (Minneapolis) → named it Agile Self-Care → wrote the 12 principles fall 2018 → first delivered at the April 2019 local meetup → renamed Agile Best Self sometime after
- April 2019 meetup: 70+ attendees; website launched the day after
- Newcomer/established contrast: at April 2019 meetup, Michaele was established; Brian was largely unknown
- Michaele Gardner: co-creator, connector and catalyst
- ABS Principle 8: being more over doing more
- The North Star Workshop: Gervais-based keyword method
- The keyword: Pictures — revealed here for the first time in the book
- Gervais criteria: 25 words or fewer, speakable under duress, felt in the body
- Physical response: spine and shoulders
- Jim: circle member, Lac Seul photo as confirmation receipt (see Working Notes — photo also appears in Ch. 5)
- Snyder: agency and pathways (endnote 13)
- McGonigal: Episodic Future Thinking, future self as stranger (endnote 14)
- Gervais: Finding Your Best (endnote 15)
- Clear: Atomic Habits, identity-based habits (endnote 16)
- Conley: Modern Elder, accumulated wisdom as asset (endnote 17)
- Gupta: purpose vs. obligation, neurochemistry of meaning (endnote 18)
**References back to:**
...
**Continuity notes:**
- Daniel Pink: JD not PhD, never "Dr."
- Father not named in book — do not name unless confirmed
- ABS = mindset, never framework; brief grounding sentence on first use confirmed here
**Key quotes:**
- "My father wrote Principles 7 and 8 forty years before I did."
- "The inner critic is very happy to offer things to do that prioritize comfort over progress. That is a feature, not a bug."
- "Go be the healthy person in those pictures."
- "The keyword doesn't replace the work. It starts it."
- "What you have built over decades is not a weight. It is an asset."
- "Look back before you look forward. The foundation is already under you. The work is learning to stand on it."
**Chapter 4 Endnotes**
12 Sutherland, Jeff, and Sutherland, J.J. *Scrum: The Art of Doing Twice the Work in Half the Time*. Crown Business, 2014.
13 Snyder, C.R. *The Psychology of Hope: You Can Get There from Here*. Free Press, 1994.
14 McGonigal, Jane. *Imaginable: How to See the Future Coming and Feel Ready for Anything*. Spiegel &amp; Grau, 2022.
15 Gervais, Dr. Michael. *Finding Your Best: The 12-Week Mental Performance Program for Elite Athletes, Coaches, and Business Leaders*. HarperOne, 2024.
16 Clear, James. *Atomic Habits: An Easy &amp; Proven Way to Build Good Habits &amp; Break Bad Ones*. Avery, 2018.
17 Conley, Chip. *Wisdom at Work: The Making of a Modern Elder*. Currency, 2018.
18 Gupta, Dr. Sanjay. *Keep Sharp: Build a Better Brain at Any Age*. Simon &amp; Schuster, 2021.
...
***Chapter Notes***
**Introduced in this chapter:**
- The two inner critic voices: mocking (self/competence) and judgy (father/worthiness)
- The inner critic as ego protection mechanism — design, not malice
- FOPO: Fear of Other People's Opinions (Gervais)
- The ABS April 2019 story: FOPO in the community; March 2020 as the moment purpose overrode fear
- Positive Intelligence framework (Chamine): Hyper Vigilant 8, Pleaser 8, Hyper Achiever 6
- Hyper Vigilant: over-tracking; Whoop cancellation as receipt it was managed
- Hyper Achiever: fills ambiguous receipts with the worst story; scale going up — muscle not drift
- Pleaser: weight of being the dependable one; professional project; legacy as the real fuel
- Shame (Brown): the critic's deepest weapon; the floor
- The 5 second rule (Robbins): prefrontal cortex, the bench press story
- The inner advocate: two versions (self-voice, kids' voice); the post-surgery morning
**References back to:**
- Chapter 1: inner critic as ego protection mechanism; Snyder's agency
- Chapter 2: receipts; We Power; the circle
- Chapter 3: Whoop; the Hyper Vigilant and tracking; scale ambiguity
- Chapter 4: Pictures; the father; Scrum values as floor
**References forward:**
- Chapter 6: the circle introduced fully
- Chapter 8: drift concept (Hyper Achiever filling the gap)
**Planned endnotes:**
- 15: Gervais, Dr. Michael — Finding Your Best (FOPO)
- 16: Robbins, Mel — The 5 Second Rule
- 19: Chamine, Shirzad — Positive Intelligence
- 20: Brown, Brené — Daring Greatly
- 21: Wakeman, Cy — Reality-Based Leadership
- 22: Brown, Brené — Daring Greatly (Roosevelt epigraph)
**Key quotes:**
- "A named thing loses some of its power. Not all of it. Enough."
- "The critic borrowed the voice. The advocate earned the answer."
- "The loudness is not evidence that you are wrong. It is evidence that you are growing."
- "The inner critic doesn't wait for evidence. The hope practice does."
- "When letting go of a tracking tool feels like freedom rather than risk, the Hyper Vigilant saboteur no longer runs the show."
- "FOPO doesn't lose arguments. It loses its grip."
- "The advocate didn't need to be loud. It just needed to be present."
